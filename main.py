...
st.markdown(
    ...
    .login-container input, .dashboard-container input {
        width: 100%;
        padding: 10px;
        margin: 10px 0;
...
if authenticate_user():
    ...
    app_mode = st.sidebar.selectbox("Select Page",["Home","About","Prerequisites","Disease Recognition"])
    ...
    elif(app_mode=="Prerequisites"):
        st.header("Prerequisites")
        st.markdown("""
                    #### 
                    Use only pictures of Plant leaf.
                    """)
        st.markdown("""
